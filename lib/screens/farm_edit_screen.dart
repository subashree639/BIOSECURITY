...
class _FarmEditScreenState extends State<FarmEditScreen> with TickerProviderStateMixin {
  ...
  late String _selectedProductionSystem;
  late List<String> _selectedEquipment;
  late List<String> _farmPhotos;
  ...
  final List<Map<String, dynamic>> _steps = [
    ...
    {
      'title': 'Farm Details',
      'subtitle': 'Species and production',
      'icon': Icons.agriculture,
      'color': const Color(0xFF2196F3),
    },
    {
      'title': 'Location & Size',
      'subtitle': 'GPS and capacity',
      'icon': Icons.location_on,
      'color': const Color(0xFFFF9800),
    },
    {
      'title': 'Equipment & Photos',
      'subtitle': 'Facilities and images',
  ...
  void initState() {
    ...
    // Initialize with existing farm data
    _farmNameController = TextEditingController(text: widget.farm.farmName);
    _ownerNameController = TextEditingController(text: widget.farm.ownerName);
    _villageController = TextEditingController(text: widget.farm.locationText);
    ...
    _farmSizeController = TextEditingController(text: widget.farm.size.toString());

    _selectedSpecies = widget.farm.species;
    _selectedProductionSystem = 'backyard'; // Default, could be stored in farm model
    _selectedEquipment = []; // Could be stored in farm model
    _farmPhotos = List.from(widget.farm.photos);
              ...
              children: [
                ...
                Expanded(
                  child: ElevatedButton(
                    onPressed: _currentStep == _steps.length - 1 ? _saveChanges : _onStepContinue,
                    ...
                    child: Text(
                      _currentStep == _steps.length - 1 ? 'Save Changes' : 'Continue',
                      style: const TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.w600,
                      ),
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        label: Text(_locationDetected ? 'Updated' : 'GPS'),
                        style: ElevatedButton.styleFrom(
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'Location updated and village/town auto-filled',
                            style: TextStyle(
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Use GPS to automatically update your location and fill the village/town field. This ensures accurate farm mapping for emergency response.',
                    style: TextStyle(
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text(
                'Update the primary animal species raised on your farm.',
                style: TextStyle(
                  color: Colors.grey[600],
                  fontSize: 14,
                  height: 1.4,
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text(
                'Update the scale and type of your farming operation.',
                style: TextStyle(
                  color: Colors.grey[600],
                  fontSize: 14,
                  height: 1.4,
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text(
                'Update accurate location coordinates for emergency response and regional disease tracking.',
                style: TextStyle(
                  color: Colors.grey[600],
                  fontSize: 14,
                  height: 1.4,
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(_locationDetected ? 'Location Updated' : 'Update My Location'),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: _locationDetected
                        ? Colors.green
                        : _steps[_currentStep]['color'],
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text(
                'Update the total number of animals currently on your farm.',
                style: TextStyle(
                  color: Colors.grey[600],
                  fontSize: 14,
                  height: 1.4,
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text(
                'Update equipment and facilities available on your farm. This helps with risk assessments and compliance tracking.',
                style: TextStyle(
                  color: Colors.grey[600],
                  fontSize: 14,
                  height: 1.4,
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text(
                'Update photos of your farm facilities, animals, and equipment. These help with assessments and record-keeping.',
                style: TextStyle(
                  color: Colors.grey[600],
                  fontSize: 14,
                  height: 1.4,
  ...
  Future<void> _saveChanges() async {
    // Validate all required fields manually since form spans multiple steps
    ...
    try {
      final updatedFarm = Farm(
        ...
        locationText: _villageController.text.trim(),
        latitude: double.tryParse(_latitudeController.text.trim()),
        longitude: double.tryParse(_longitudeController.text.trim()),
        species: _selectedSpecies,
        size: int.tryParse(_farmSizeController.text.trim()) ?? 0,
        photos: _farmPhotos,
        createdBy: widget.farm.createdBy,
      );

      // Update farm in database
      await DatabaseHelper().updateFarm(updatedFarm);
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Error updating farm data: $e'),
            backgroundColor: Colors.red,
          ),
        );
      }
  ...
  bool _validateAllFields() {
    ...
    if (_farmNameController.text.trim().isEmpty) {
      _showValidationError('Farm name is required');
      setState(() => _currentStep = 0);
      return false;
    }

    if (_ownerNameController.text.trim().isEmpty) {
      _showValidationError('Owner name is required');
      setState(() => _currentStep = 0);
      return false;
    }

    if (_villageController.text.trim().isEmpty) {
      _showValidationError('Village/Town is required');
      setState(() => _currentStep = 0);
      return false;
    }
    ...
    if (lat == null || lat < -90 || lat > 90) {
      _showValidationError('Please enter valid latitude');
      setState(() => _currentStep = 2);
      return false;
    }

    if (lng == null || lng < -180 || lng > 180) {
      _showValidationError('Please enter valid longitude');
      setState(() => _currentStep = 2);
      return false;
    }

    final size = int.tryParse(_farmSizeController.text.trim());
    if (size == null || size <= 0) {
      _showValidationError('Please enter valid farm size');
      setState(() => _currentStep = 2);
      return false;
    }
